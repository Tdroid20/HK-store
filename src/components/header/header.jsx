                ...
                <div className='NavItems'>
                    ...
                    {user != null && (<>
                        ...
                        <div className="btn-group">
                            <button type="button" className="btn btn-secondary HP-UserColor" onClick={openModal}><a className='HP-Username'><img src={user.discordAvatar} alt="" className='HP-Avatar' />{user.discordUsername}</a></button>
                            ...
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="/leaderboard">Leaderboard {<DangerBadge flagName="NEW" />}</a></li>
                                <li><a className="dropdown-item" href="#">Another action</a></li>
                                <li><a className="dropdown-item" href="#">Something else here</a></li>
                                <li><hr className="dropdown-divider" /></li>
                                <li><a className="dropdown-item HP-LogoutColor" href={process.env.REACT_APP_API + "/auth/logout"}><i className="fa-solid fa-right-from-bracket"></i> Logout</a></li>
                            </ul>
                        </div>
                    </>)}
